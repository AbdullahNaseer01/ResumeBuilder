		...
		C435.391,473.741,421.951,478.349,409.378,482.706z"
                  ...
                  <div className="flex flex-col sm:w-2/3 order-first sm:order-none sm:-mt-10">
                    ...
                    <div className="py-3">
                      ...
                      <div className="border-2 w-20 border-top-color my-3" />
                      <p>
                        To get a career opportunity which would help me to
                        utilize my academic background to assist me to gain
                        experience, employ my excellent skills, and enable me to
